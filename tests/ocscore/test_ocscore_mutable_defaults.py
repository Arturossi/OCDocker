...
@pytest.mark.parametrize(
    ...
    [
        ("OCDocker/OCScore/Utils/Workers.py", None, "GAWorker", "best_params"),
        ("OCDocker/OCScore/Utils/Workers.py", None, "XGBworker", "params"),
        ("OCDocker/OCScore/Optimization/DNN.py", None, "optimize_NN", "data"),
        ("OCDocker/OCScore/Optimization/DNN.py", None, "perform_ablation_study_NN", "masks"),
        ("OCDocker/OCScore/Optimization/DNN.py", None, "perform_seed_ablation_study_NN", "seeds"),
        ("OCDocker/OCScore/Optimization/XGBoost.py", None, "optimize_XGB", "data"),
        ("OCDocker/OCScore/Optimization/Transformer.py", None, "optimize_Transformer", "data"),
        ("OCDocker/OCScore/XGBoost/OCxgboost.py", None, "run_xgboost", "params"),
        ("OCDocker/OCScore/XGBoost/XGBoostOptimizer.py", "XGBoostOptimizer", "__init__", "params"),
        ("OCDocker/OCScore/Transformer/TransOptimizer.py", "TransformerModel", "__init__", "init_params"),
    ],
)
