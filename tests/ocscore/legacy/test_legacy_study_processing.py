...
###############################################################################
'''
Coverage tests for OCScore.Analysis.legacy.StudyProcessing helpers.
'''
...
import OCDocker.OCScore.Analysis.legacy.StudyProcessing as ocstudyproc
...
def test_legacy_analysis_namespace_lists_study_modules():
    import OCDocker.OCScore.Analysis.legacy as legacy

    assert "OCDocker.OCScore.Analysis.legacy.StudyProcessing" in legacy.LEGACY_ANALYSIS_MODULES
    assert "OCDocker.OCScore.Analysis.Metrics.Ranking" not in legacy.LEGACY_ANALYSIS_MODULES
