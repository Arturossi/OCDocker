...
# Load the study
ao_study = optuna.load_study(study_name = f"AO_Optimization_11_TPE", storage = storage)
...
# Load the study
nn_study = optuna.load_study(study_name = f"NN_Optimization_11_TPE", storage = storage)
