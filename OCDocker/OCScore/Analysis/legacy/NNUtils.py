...
LOGGER = oclogging.get_logger("ocscore.analysis.nn_utils")
...
def run_ae_feature_importance(
    ...
    LOGGER.info("Running AE-based permutation importance.")
    ...
    LOGGER.info("AE feature importance analysis completed.")
