...
import OCDocker.OCScore.Analysis.legacy.Correlation as occorrana
import OCDocker.OCScore.Analysis.legacy.NNUtils as ocnnutils
...
LOGGER = oclogging.get_logger("ocscore.analysis.performance_evaluation")
...
def run_full_analysis(
    ...
    for n_trials in trials_list:
        LOGGER.info("Running analysis for top %d trials.", n_trials)
