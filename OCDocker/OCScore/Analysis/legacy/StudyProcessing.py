...
###############################################################################
'''
Legacy Optuna study parsing (best-RMSE, best-AUC, best-combined views).

Prefer ``Optimization.StagedOptuna`` for current OCScore training.

Usage:

from OCDocker.OCScore.Analysis.legacy.StudyProcessing import get_study_data
'''
