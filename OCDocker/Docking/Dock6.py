...
class Dock6:
    ...
    def __init__(self, configPath: str, boxFile: str, receptor: ocr.Receptor, preparedReceptorPath: str, ligand: ocl.Ligand, preparedLigandPath: str, dock6Log: str, outputDock6: str, name: str = "", overwriteConfig: bool = False, spacing: float = 2.9) -> None:
        ...
        self.active_site_pdb = f"{outputDock6}/receptor_active_site.pdb"

        # Write the active site to the outputDock6 folder
        self.write_active_site()

        # Dock
        self.dock6Log = str(dock6Log)
        self.outputDock6 = str(outputDock6)
        self.dock6Cmd = []
        ...
        # Aliases
        ############
        self.run_docking = self.run_dock6
    ...
    def write_active_site(self):
        ...
        write_active_site(self.boxFile, self.inputReceptorPath, self.inputLigandPath, self.active_site_pdb, self.outputDock6, spacing = spacing)
...
def box_to_dock6(boxFile: str, confFile: str, receptor: str) -> int:
    '''Convert a box (DUDE like format) to Dock6 input.
