...
class Dock3:
    ...
    def __init__(self, configPath: str, boxFile: str, receptor: ocr.Receptor, preparedReceptorPath: str, ligand: ocl.Ligand, preparedLigandPath: str, dock3Log: str, outputDock3: str, name: str = "", overwriteConfig: bool = False, spacing: float = 2.9) -> None:
        ...
        if type(ligand) == ocl.Ligand:
            ...
            _ = ocff.safe_create_dir(os.path.join(os.path.dirname(ligand.path), "dock3Files"))
        else:
        ...
        self.active_site_pdb = f"{outputDock3}/receptor_active_site.pdb"

        # Write the active site to the outputDock3 folder
        self.write_active_site()

        # Dock
        self.dock3Log = str(dock3Log)
        self.outputDock3 = str(outputDock3)
        self.dock3Cmd = []
        ...
        # Aliases
        ############
        self.run_docking = self.run_dock3
    ...
    def write_active_site(self):
        ...
        write_active_site(self.boxFile, self.inputReceptorPath, self.inputLigandPath, self.active_site_pdb, self.outputDock3, spacing = spacing)
...
def box_to_dock3(boxFile: str, confFile: str, receptor: str) -> int:
    '''Convert a box (DUDE like format) to Dock3 input.
