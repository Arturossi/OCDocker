...
def read_mmap(file_name: str) -> Generator[str, None, None]:
    ...
    with open(file_name, 'rb') as read_obj:
        with mmap.mmap(read_obj.fileno(), 0, access=mmap.ACCESS_READ) as mmap_obj:
            yield mmap_obj.readline().decode('utf-8')

def read_reverse_order_mmap(file_name: str) -> Generator[str, None, None]:
    '''Read a file in reverse order using mmap.
