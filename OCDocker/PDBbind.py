...
def verify_integrity():
    ...
    for dir in tqdm(iterable=dirs, total=len(dirs)):
        ...
        octools.printv(f"Checking files for the protein '{dis}'")
    ...
    octools.printv("Integrity check of the PDBbind database accomplished.")
