#!/usr/bin/env python3
"""
Example 13: Running Python scripts with OCDocker pre-loaded
...
Usage:
    ocdocker script --conf OCDocker.cfg examples/13_cli_script_example.py
...
print("\nTo use this script:")
print("  ocdocker script --conf OCDocker.cfg examples/13_cli_script_example.py [args...]")
